...
class SwapRequestSimpleResultsWidget extends StatefulWidget {
  const SwapRequestSimpleResultsWidget({Key? key}) : super(key: key);

  @override
  _SwapRequestSimpleResultsWidgetState createState() =>
      _SwapRequestSimpleResultsWidgetState();
}

class _SwapRequestSimpleResultsWidgetState
    extends State<SwapRequestSimpleResultsWidget> {
