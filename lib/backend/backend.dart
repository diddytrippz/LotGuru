...
import 'schema/new_locations_record.dart';
...
export 'schema/new_locations_record.dart';
...
/// Functions to query NewLocationsRecords (as a Stream and as a Future).
Stream<List<NewLocationsRecord>> queryNewLocationsRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      NewLocationsRecord.collection(parent),
...
Future<List<NewLocationsRecord>> queryNewLocationsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<NewLocationsRecord>> queryNewLocationsRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
