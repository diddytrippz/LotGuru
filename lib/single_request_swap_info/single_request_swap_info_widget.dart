...
class SingleRequestSwapInfoWidget extends StatefulWidget {
  const SingleRequestSwapInfoWidget({Key? key}) : super(key: key);

  @override
  _SingleRequestSwapInfoWidgetState createState() =>
      _SingleRequestSwapInfoWidgetState();
}

class _SingleRequestSwapInfoWidgetState
    extends State<SingleRequestSwapInfoWidget> {
