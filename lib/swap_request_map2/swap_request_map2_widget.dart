...
class SwapRequestMap2Widget extends StatefulWidget {
  const SwapRequestMap2Widget({Key? key}) : super(key: key);

  @override
  _SwapRequestMap2WidgetState createState() => _SwapRequestMap2WidgetState();
}

class _SwapRequestMap2WidgetState extends State<SwapRequestMap2Widget> {
