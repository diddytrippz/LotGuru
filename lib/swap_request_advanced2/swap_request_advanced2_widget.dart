...
class SwapRequestAdvanced2Widget extends StatefulWidget {
  const SwapRequestAdvanced2Widget({Key? key}) : super(key: key);

  @override
  _SwapRequestAdvanced2WidgetState createState() =>
      _SwapRequestAdvanced2WidgetState();
}

class _SwapRequestAdvanced2WidgetState
    extends State<SwapRequestAdvanced2Widget> {
