...
class SwapRequestSimpleWidget extends StatefulWidget {
  const SwapRequestSimpleWidget({Key? key}) : super(key: key);

  @override
  _SwapRequestSimpleWidgetState createState() =>
      _SwapRequestSimpleWidgetState();
}

class _SwapRequestSimpleWidgetState extends State<SwapRequestSimpleWidget> {
