...
class SwapRequestInfoWidget extends StatefulWidget {
  const SwapRequestInfoWidget({Key? key}) : super(key: key);

  @override
  _SwapRequestInfoWidgetState createState() => _SwapRequestInfoWidgetState();
}

class _SwapRequestInfoWidgetState extends State<SwapRequestInfoWidget> {
