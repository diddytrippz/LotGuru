...
class SwapRequestAdvancedWidget extends StatefulWidget {
  const SwapRequestAdvancedWidget({Key? key}) : super(key: key);

  @override
  _SwapRequestAdvancedWidgetState createState() =>
      _SwapRequestAdvancedWidgetState();
}

class _SwapRequestAdvancedWidgetState extends State<SwapRequestAdvancedWidget> {
